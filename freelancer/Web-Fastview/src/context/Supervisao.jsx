...
export const SupervisaoContext = createContext();

export const SupervisaoProvider = ({ children }) => {
  ...
  return (
    <SupervisaoContext.Provider value={value}>{children}</SupervisaoContext.Provider>
  );
};
