...
export default function AtingimentoRedes({ filters, callback }) {
    // ESTADOS
        ...
        <Col>
            <Dashboard
                ...
                cols={
                    {
                        col_1: {
                            title: 'Ating. Redes - ' + get_date('month_name', get_date('date', '01/' + filters?.monthSelected + '/' + filters?.yearSelected, 'date_sub_month', 0)),
                            api: {
                                url: window.host + '/systems/checklist/api/lista.php',
                                params: {
                                    do: 'get_redes_dashboard',
                                ...
                                dash1.length > 0 ?
                                    dash1.map((item) => {
                                        return (
                                            ...
                                            // active={(filters?.supervisorActive == item.supervisor_id ? true : false)}
                                            >
                                                <Td
                                                // onClick={() => handleClickSupervisor(filters?.supervisorActive == item.id_supervisor_id ? '' : item.id_supervisor_id)}
                                                // cursor="pointer"
                                                >
                                                    {item.empreendimento}
                                                </Td>
                                                ...
                                                <Td align="center" //</Tr>cursor="pointer" onClick={() => handleClickNumber(item.id_supervisor_loja, undefined, undefined, undefined, undefined, undefined, 1)}
                        ...
                        col_2: {
                            title: 'Ating. Redes - ' + get_date('month_name', get_date('date', '01/' + filters?.monthSelected + '/' + filters?.yearSelected, 'date_sub_month', 1)),
                            api: {
                                url: window.host + '/systems/checklist/api/lista.php',
                                params: {
                                    do: 'get_redes_dashboard',
                        ...
                        col_3: {
                            title: 'Ating. Redes - ' + get_date('month_name', get_date('date', '01/' + filters?.monthSelected + '/' + filters?.yearSelected, 'date_sub_month', 2)),
                            api: {
                                url: window.host + '/systems/checklist/api/lista.php',
                                params: {
                                    do: 'get_redes_dashboard',
