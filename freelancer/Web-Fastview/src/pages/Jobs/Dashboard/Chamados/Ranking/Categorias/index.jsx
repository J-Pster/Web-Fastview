...
export default function Categorias({chartOptions, filters, callback}){
    // ESTADOS
                ...
                title={
                    <>
                        ...
                        <span className="ms-1 cursor-pointer" onClick={handleChange}>
                            <span className="text-primary font-weight-bold">Categorias</span> <Icon type="change" className="mx-1" title={false} readonly /> Subcategorias
                        </span>
                    </>
                }
