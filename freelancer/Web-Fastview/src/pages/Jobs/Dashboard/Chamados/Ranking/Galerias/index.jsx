...
export default function Galerias({chartOptions, filters, callback}){
    // ESTADOS
        ...
        axios({
            ...
            if(response?.data){
                ...
                response?.data?.map((item, i) => {
                    data_aux.push([item?.sigla_nome, parseInt(item?.qtd_inferior), parseInt(item?.qtd_superior)]);
                });
                ...
                title={
                    <>
                        ...
                        <span className="ms-1 cursor-pointer" onClick={handleChange}>
                            <span className="text-primary font-weight-bold">Galerias</span> <Icon type="change" className="mx-1" title={false} readonly /> Lojas
                        </span>
                    </>
                }
