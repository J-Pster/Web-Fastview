...
export default function Supervisores({filters, callback}){
    // ESTADOS
    ...
    // GET RESULTADOS DA PRIMEIRA COLUNA DE SUPERVISORES
    ...
    // GET RESULTADOS DA SEGUNDA COLUNA DE SUPERVISORES
    ...
    // GET RESULTADOS DA TERCEIRA COLUNA DE SUPERVISORES
        ...
        <Col>
            <Dashboard
                ...
                cols={
                    {
                        col_1: {
                            title: 'Supervisores - '+get_date('month_name',get_date('date','01/'+filters?.monthSelected+'/'+filters?.yearSelected,'date_sub_month',0)),
                            api: {
                                ...
                                params: {
                                    ...
                                    filter_active_2: [0, 1],
                                    reload: (filters?.filterModule + filters?.monthSelected + filters?.yearSelected + filters?.supervisorActive + JSON.stringify(order)),
                                    order_by: order,
                            ...
                            tbody:(
                                dash1.length>0?
                                    dash1.map((item) => {
                                        return(
                                            <Tr
                                                key={item.id_usuario_sup}
                                                active={(filters?.supervisorActive == item.id_usuario_sup ? true : false)}                                                        
                                            >
                                                <Td
                                                    onClick={() => handleClickSupervisor(filters?.supervisorActive == item.id_usuario_sup ? '' : item.id_usuario_sup)}
                                                    cursor="pointer"
                                                >
                                                    {item.nome_usuario_sup}
                                                </Td>

                                                <Td align="center" cursor="pointer" onClick={() => handleClickNumber(item.id_usuario_sup, undefined, undefined, undefined, undefined, undefined, -2)}>{item.qtd_atrasado}</Td>
                                                <Td align="center" cursor="pointer" onClick={() => handleClickNumber(item.id_usuario_sup, undefined, undefined, undefined, undefined, undefined, 1)}>{item.qtd_feito}</Td>
                                                <Td align="center" cursor="pointer" onClick={() => handleClickNumber(item.id_usuario_sup, undefined, undefined, undefined, undefined, undefined, 3)}>{item.qtd_feito_com_atraso}</Td>
                                                <Td align="center" cursor="pointer" onClick={() => handleClickNumber(item.id_usuario_sup, undefined, undefined, undefined, undefined, undefined, 2)}>{item.qtd_nao_tem}</Td>
                                            </Tr>
                                        )
                                    })
                                :
                        ...
                        col_2: {
                            title: 'Supervisores - '+get_date('month_name',get_date('date','01/'+filters?.monthSelected+'/'+filters?.yearSelected,'date_sub_month',1)),
                            api: {
                                url: window.host_madnezz+'/systems/integration-react/api/request.php',
                                params: {
                                    db_type: global.db_type,
                            ...
                            tbody:(
                                dash2.length > 0?
                                    dash2.map((item) => {
                                        return(
                                            <Tr key={item.id_usuario_sup}>
                                                <Td>{item.nome_usuario_sup}</Td>
                        ...
                        col_3: {
                            title: 'Supervisores - '+get_date('month_name',get_date('date','01/'+filters?.monthSelected+'/'+filters?.yearSelected,'date_sub_month',2)),
                            api: {
                                url: window.host_madnezz+'/systems/integration-react/api/request.php',
                                params: {
                                    db_type: global.db_type,
